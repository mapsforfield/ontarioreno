  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans text-slate-900">
      {shouldShowContractorBanner && (
        ...
        >
          <div className="relative mx-auto flex min-h-[4.25rem] max-w-7xl items-center justify-center px-7 py-4 text-center sm:min-h-0 sm:px-14 sm:py-3">
            <p className="mx-auto max-w-[21.5rem] text-[0.82rem] font-medium leading-[1.45] tracking-[-0.01em] text-white/92 sm:max-w-none sm:text-sm sm:leading-6">
            ...
            <button
              ...
              className="absolute right-1 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full text-white/75 transition hover:bg-white/10 hover:text-white focus-visible:ring-white/25 sm:right-4"
