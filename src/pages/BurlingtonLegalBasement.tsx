...
const requirementSteps = [
  ...
  },
  {
    ...
    detail:
      'City of Burlington permit expectations and broader Halton housing context can both affect how the project is structured.',
  },
  {
    step: '03',
  ...
  },
  {
    ...
    detail:
      'If the City asks for updates, complete revision responses matter more than fast but incomplete replies.',
  },
  {
    step: '06',
...
const faqs = [
  {
    question: 'What makes a basement legal in Burlington?',
    answer:
      'It needs permit approval, code-compliant design, and a layout that satisfies City of Burlington review for the intended use.',
  },
  {
  ...
  {
    question: 'Do retrofit issues matter more in Burlington legal basements?',
    answer:
      'They can. Older homes often need more careful planning around exits, service updates, and existing conditions, while newer homes may start unfinished but still need full compliance once a unit is created.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Start by comparing the Burlington cost page, the Burlington permit page, and your intended use before asking contractors for final pricing.',
  },
];

export default function BurlingtonLegalBasement() {
  const [activeFaq, setActiveFaq] = useState<number | null>(0);

  return (
    <div className="min-h-screen bg-slate-50">
      <Helmet>
        <title>Legal Basement in Burlington | OntarioReno</title>
        <meta
          name="description"
          content="Learn what a legal basement in Burlington usually requires, how City of Burlington permits affect the project, and what changes once a basement is planned as a second unit."
        />
        <link
          rel="canonical"
          href="https://ontarioreno.ca/legal-basement-burlington"
        />
      </Helmet>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[minmax(0,1fr)_460px] lg:items-center lg:px-8 lg:py-24">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-6 text-4xl font-bold leading-tight md:text-6xl">
              Legal Basement in Burlington
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">
              A legal basement in Burlington usually requires more than a nice
              finish. It means permit approval, code-compliant design, and a layout
              that works under City of Burlington review.
            </p>

            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-400">
              This page explains what typically separates a finished basement from a
              legal one, and how cost, permits, retrofit considerations, and
              Halton-area planning start connecting once the space is meant to work
              independently.
            </p>
          ...
          <div className="space-y-8">
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              <h2 className="text-3xl font-bold text-slate-900">
                Finished basement vs legal basement in Burlington
              </h2>
              <div className="mt-8 grid gap-6 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-[#1B3C6C]/20 bg-blue-50 p-6">
                  ...
                  <p className="mt-4 leading-7 text-slate-700">
                    ...
                    code detail, and clearer City of Burlington review
                    documentation.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-600">
                ...
                <Link
                  ...
                  className="font-semibold text-slate-900 underline underline-offset-4"
                >
                  Burlington permit page
                </Link>{' '}
                explains where City of Burlington review typically starts affecting
                the timeline.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-blue-200 bg-blue-50 p-8 shadow-sm">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-700">
                ...
                becomes, the more the project depends on correct drawings, retrofit
                planning, permit strategy, and the right contractor fit.
              </p>
              <div className="mt-6">
                <Link
                  to="/legal-suites"
      ...
      <section className="border-y border-slate-200 bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Most legal basement projects in Burlington move through a similar
              approval sequence.
            </p>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Direct answers about legal basement planning in Burlington.
            </p>
          </div>
