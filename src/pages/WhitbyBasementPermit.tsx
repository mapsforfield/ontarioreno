...
const timelineSteps = [
  ...
  },
  {
    ...
    detail:
      'Town of Whitby permits are commonly triggered by walls, plumbing, electrical changes, bedrooms, and legal-suite work.',
  },
  {
    step: '03',
  ...
  {
    step: '04',
    title: 'Submit to Whitby',
    detail:
      'Your package moves through the Town of Whitby building permit review process for municipal evaluation.',
  },
  {
    step: '05',
...
const faqs = [
  {
    question: 'Do I need a permit to finish a basement in Whitby?',
    answer:
  ...
  {
    question: 'Do newer Whitby homes avoid permit requirements?',
    answer:
  ...
  {
    question: 'Do layouts and retrofits affect Whitby permit planning?',
    answer:
  ...
  {
    question: 'What causes the biggest permit delays in Whitby?',
    answer:
      'Unclear scope, incomplete drawings, layout questions, retrofit details, and slow revision responses cause most delays.',
  },
];

export default function WhitbyBasementPermit() {
  const [activeFaq, setActiveFaq] = useState<number | null>(0);

  return (
    <div className="min-h-screen bg-slate-50">
      <Helmet>
        <title>Basement Permit in Whitby | OntarioReno</title>
        <meta
          name="description"
          content="Learn when a basement permit is required in Whitby, what usually triggers Town of Whitby review, and how permits connect to legal basement planning."
        />
        <link
          rel="canonical"
          href="https://ontarioreno.ca/basement-permit-whitby"
        />
      </Helmet>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[minmax(0,1fr)_460px] lg:items-center lg:px-8 lg:py-24">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-500/15 px-4 py-2 text-sm font-medium text-blue-200 ring-1 ring-white/10">
              ...
              Whitby basement permit guide
            </div>

            <h1 className="mt-6 text-4xl font-bold leading-tight md:text-6xl">
              Basement Permit in Whitby
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">
              In many cases, yes. If you are finishing a basement in Whitby
              and adding walls, plumbing, electrical, or planning a legal unit,
              a permit is usually part of the job.
            </p>

            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-400">
              This guide explains the basement permit Whitby homeowners
              commonly need, what work usually triggers Town of Whitby
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
            ...
            <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
              The bigger the basement scope becomes, the more likely Town of
              Whitby permits need to be part of the plan.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:px-8">
          <div className="space-y-8">
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-600">
                ...
                building toward a legal unit, Town of Whitby permits usually
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h3 className="mt-5 text-2xl font-bold text-slate-900">Whitby cluster</h3>
      ...
      <section className="border-y border-slate-200 bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Once the scope clearly needs a permit, most Whitby basement
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Direct answers for Whitby homeowners planning basement work.
            </p>
          </div>
