  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {isAnnouncementVisible && (
        <div className="relative z-20 border-b border-white/10 bg-[linear-gradient(90deg,#0a1424_0%,#0f2f55_55%,#0a1424_100%)] px-4 text-white shadow-[0_12px_28px_rgba(3,7,18,0.18)]">
