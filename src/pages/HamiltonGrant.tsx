...
export default function HamiltonGrant() {
  return (
    <main className="bg-white text-slate-900">
      <Helmet>
        <title>Hamilton Basement Grant $40,000 | Legal Secondary Suite Incentive</title>
        <meta
          name="description"
          content="Learn how the Hamilton basement grant works for legal basement apartments and secondary units. See eligible costs, calculator estimates, and how homeowners may qualify for up to $40,000."
        />
        <meta
          property="og:title"
          content="Hamilton Basement Grant $40,000 | Legal Secondary Suite Incentive"
        />
        <meta
          property="og:description"
          content="Learn how the Hamilton basement grant works for legal basement apartments and secondary units. See eligible costs, calculator estimates, and how homeowners may qualify for up to $40,000."
        />
        <meta property="og:url" content="https://ontarioreno.ca/hamilton-grant-guide" />
