...
const timelineSteps = [
  {
    ...
    detail:
      'The first question is whether the basement is staying family-use, adding plumbing, changing layout, or moving toward a legal unit.',
  },
  {
    step: '02',
    title: 'Check permit triggers',
    detail:
      'Town of Milton permits are commonly triggered by walls, plumbing, electrical changes, bedrooms, and legal-suite work.',
  },
  {
    step: '03',
    title: 'Prepare drawings',
    detail:
      'Once a permit is required, the basement usually needs permit-ready drawings and a clear scope before submission.',
  },
  {
    step: '04',
    title: 'Submit to Milton',
    detail:
      'Your application package moves through the Town of Milton building permit process for review.',
  },
  {
    step: '05',
    title: 'Address revisions',
    detail:
      'If reviewers ask for updates, the file slows down until the fixes are complete and resubmitted clearly.',
  },
  {
    step: '06',
    title: 'Build after issuance',
    detail:
      'If a permit was required, work should begin only after the permit is issued and inspections are lined up as needed.',
  },
];

const faqs = [
  {
    question: 'Do I need a permit to finish a basement in Milton?',
    answer:
      'Often yes, especially if the project includes walls, plumbing, electrical changes, bedrooms, or layout changes beyond cosmetics.',
  },
  {
    question: 'Do newer Milton homes avoid permit requirements?',
    answer:
  ...
  {
    question: 'Does a basement bathroom usually require a permit?',
    answer:
      'In most cases, yes. Plumbing work is one of the clearest Town of Milton permit triggers.',
  },
  {
  ...
  {
    question: 'What causes the biggest permit delays in Milton?',
    answer:
      'Unclear scope, incomplete drawings, zoning questions, and slow revision responses cause most delays.',
  },
];

export default function MiltonBasementPermit() {
  const [activeFaq, setActiveFaq] = useState<number | null>(0);

  return (
    <div className="bg-slate-50 min-h-screen">
      <Helmet>
        <title>Basement Permit in Milton | OntarioReno</title>
        <meta
          name="description"
          content="Learn when a basement permit is required in Milton, what usually triggers Town of Milton review, and how permits connect to legal basement planning."
        />
        <link
          rel="canonical"
          href="https://ontarioreno.ca/basement-permit-milton"
        />
      </Helmet>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[minmax(0,1fr)_460px] lg:items-center lg:px-8 lg:py-24">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-500/15 px-4 py-2 text-sm font-medium text-blue-200 ring-1 ring-white/10">
              ...
              Milton basement permit guide
            </div>

            <h1 className="mt-6 text-4xl font-bold leading-tight md:text-6xl">
              Basement Permit in Milton
            </h1>

            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">
              In many cases, yes. If you are finishing a basement in Milton and
              adding walls, plumbing, electrical, or planning a legal unit, a
              permit is usually part of the project.
            </p>

            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-400">
              This guide explains the basement permit Milton homeowners usually
              need, what work commonly triggers Town of Milton review, and how
              permit scope changes pricing and planning.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
            ...
            <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
              The bigger the basement scope becomes, the more likely Town of Milton permits need to be part of the plan.
            </p>
            <ul className="mt-6 space-y-3 text-slate-700">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-emerald-600" />
                <span>Simple finishing: permits are still common if walls, rooms, or services are being changed.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-emerald-600" />
                <span>Legal basement planning: permits are expected and usually more detailed.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-emerald-600" />
                <span>Need deeper cost context too? Review <Link to="/basement-renovation-cost-milton" className="font-semibold text-slate-900 underline underline-offset-4">Milton basement costs</Link>.</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-600">
                Cosmetic updates may not need one. But if the project is changing
                rooms, adding plumbing, altering electrical, or building toward a
                legal unit, Town of Milton permits usually become part of the job.
                If you are still deciding between a simpler finish and a legal unit,
                compare the{' '}
                <Link
                  to="/legal-basement-milton"
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 p-6">
                  ...
                  <p className="mt-4 text-slate-600 leading-7">
                    Permit needs are often simpler, but bathrooms, bedrooms, and layout changes still matter.
                  </p>
                </div>
                <div className="rounded-2xl border border-[#1B3C6C]/20 bg-blue-50 p-6">
                  ...
                  <p className="mt-4 text-slate-700 leading-7">
                    Once the basement is meant to function independently, permit review usually becomes stricter and more detailed.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-blue-200 bg-blue-50 p-8 shadow-sm">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-700">
                The cleanest permit files usually come from clear scope, stronger
                drawings, and the right contractor fit before pricing gets locked in.
              </p>
              <div className="mt-6">
                <Link
                  to="/match"
          ...
          <aside className="space-y-6">
            <div className="rounded-3xl bg-slate-900 p-8 text-white shadow-xl">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-300">
                Basement projects move better when scope, drawings, and contractor expectations are aligned early.
              </p>
              <Link
                to="/match"
      ...
      <section className="border-y border-slate-200 bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Once the scope clearly needs a permit, most Milton basement files move through the same sequence.
            </p>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Direct answers for Milton homeowners planning basement work.
            </p>
          </div>
